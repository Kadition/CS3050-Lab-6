...
for a feasible path: python3 route_planner_task1_1.py ../data/example_time_window_nodes.csv ../data/task1_edges_success.csv 1 3 dijkstra
for an infeasible path: python3 route_planner_task1_1.py ../data/example_time_window_nodes.csv ../data/task1_edges_fail.csv 1 3 dijkstra
for a case where the shortest distance path violates constraints: python3 route_planner_task1_1.py ../data/example_time_window_nodes.csv ../data/task1_edges_violation.csv 1 3 dijkstra
"""
